...
| Suites | Why |
|---|---|
| `DHE-RSA-AES128-GCM-SHA256`, `DHE-RSA-AES256-GCM-SHA384`, `DHE-RSA-AES128-SHA256`, `DHE-RSA-AES256-SHA256`, `DHE-RSA-AES128-SHA`, `DHE-RSA-AES256-SHA` | Tarantool 3.x exposes no `ssl_dh_params`, so its server uses OpenSSL's built-in DH parameters, which OpenSSL 3 rejects at the default `SECLEVEL=2`; since OpenSSL 3.2 DHE is out of the default cipher list entirely. |
